...
% 3) a partir de la anterior > threshold (surfnodes = 1) > filters > extract surface > filters > triangulate > connectivity > threshold (CellFacesIds)> guardar por separado epi y endo como .vtk
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
